  ...
  function initDatePicker(el) {
    ...
    if (inst) {
      ...
      if ($el.closest('.vits-claim-request').length) {
        ...
        var $popupAnimWrap =
          dateViewPopup && dateViewPopup.wrapper ? dateViewPopup.wrapper.closest('.k-animation-container') : null;
        ...
        if ($popupAnimWrap && $popupAnimWrap.length) {
          ...
          popupObserver.observe($popupAnimWrap[0], {attributes: true, attributeFilter: ['style']});
        }
